  ...
  Widget _buildSliverAppBar(bool isDark) {
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        centerTitle: true,
        title: const Text('TRA CỨU PHẠT NGUỘI', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18, letterSpacing: 1, color: Colors.white)),
        background: Stack(
          fit: StackFit.expand,
          children: [
            Container(decoration: BoxDecoration(gradient: AppGradients.heroBlue)),
            Positioned(right: -50, top: -20, child: Icon(Icons.security_rounded, size: 200, color: Colors.white.withValues(alpha: 0.1))),
            Center(
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('Dữ liệu chính xác từ Cục CSGT', style: TextStyle(color: Colors.white.withValues(alpha: 0.7), fontSize: 12)),
              ]),
            ),
          ],
        ),
