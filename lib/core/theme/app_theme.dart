...
class AppTheme {
  ...
  // Legacy getters for backwards compatibility - use system font as default
  static ThemeData get light => lightWithFont(FontProvider.availableFonts.first); // system
  static ThemeData get dark => darkWithFont(FontProvider.availableFonts.first); // system
}
